          ...
          <div className="response-container">
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    if (amount > 0 && amount <= autoLoanBalance) {
                      ...
                      window.dataLayer.push({
                        event: 'auto_loan_payment',
                        amount_paid: amount.toFixed(2),
                        source: 'auto_financing',
                        clickTime: new Date().toISOString(),
                      });
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    if (amount > 0 && amount <= autoLoanBalance) {
                      ...
                      window.dataLayer.push({
                        event: 'refinance_requested',
                        refinance_amount: amount.toFixed(2),
                        source: 'auto_financing',
                        clickTime: new Date().toISOString(),
                      });
                    } else if (amount > autoLoanBalance) {
            ...
            {selectedOption === "Contact Fraud Support" && (
              <div>
                <p>
                  <a
                    href="tel:1800555FRAUD"
                    onClick={() => {
                      window.dataLayer.push({
                        event: 'fraud_support_called',
                        method: 'phone_link',
                        clickTime: new Date().toISOString(),
                      });
                    }}
                  >
                    <strong>1-800-555-FRAUD</strong>
                  </a>
                </p>
              </div>
            )}
